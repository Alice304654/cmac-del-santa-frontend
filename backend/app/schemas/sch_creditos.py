...
class SolicitudCreditoResponse(BaseModel):
    status: str
    decision_inicial: str
    semaforo: str               # 'Verde', 'Ámbar', 'Rojo'
    rds_calculado: str          # Ejemplo: "32.15%"
    cuota_estimada: str         # Ejemplo: "S/ 650.00"
    instancia_aprobacion: str   # Asesor, Jefe Regional, Riesgos, Comité de Gerencia
