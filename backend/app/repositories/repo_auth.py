...
def buscar_usuario_por_username(conn: Connection, username: str) -> dict | None:
    ...
    try:    
        ...
        # 🚨 ESTO IMPRIMIRÁ EL ERROR REAL DE POSTGRES EN LA TERMINAL DEL BACKEND
        print("\n❌ [ERROR CRÍTICO EN BASE DE DATOS]:", str(db_error))
        raise db_error
