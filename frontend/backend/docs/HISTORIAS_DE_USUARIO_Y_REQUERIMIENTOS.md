...
**Producto:** Portal del cliente de **Banca Internet Caja del Santa**.
**Backend:** FastAPI (puerto 8000) sobre PostgreSQL `bd_core_financiero` (base compartida con el core; **no se crean tablas**, se reutilizan las existentes).
...
| RNF-06 | **Despliegue**: backend en puerto **8000** (el core corre en 8001; no deben colisionar). |
