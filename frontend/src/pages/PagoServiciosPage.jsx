...
const ICONOS = {
  LUZ: { icon: Zap, color: '#1e1ef7' },
  AGUA: { icon: Droplet, color: '#29f3f6' },
  TEL: { icon: Phone, color: '#24aa4e' },
  CABLE: { icon: Tv, color: '#3ba900' },
  GAS: { icon: Flame, color: '#99b50f' },
  MUNI: { icon: Building2, color: '#4c84af' },
}
