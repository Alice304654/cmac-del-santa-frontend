  ...
  return (
    <div className="lp-page">
      ...
      <section className="lp-hero">
        <div className="lp-hero-inner">
          <div className="lp-hero-text">
            <span className="lp-hero-tag">Banca Digital · Caja del Santa</span>
            <h1>Tu banco digital, <br />inspirado en el Caja del Santa</h1>
            <p>
      ...
      <section className="lp-section" id="beneficios">
        <div className="lp-section-head">
          <h2>¿Por qué Caja del Santa?</h2>
          <p>Una Caja segura y hecha para el Perú.</p>
        </div>
